<?php
	...
	class Bio2Crawler {
		...
		public function crawl() {
			...
			$objSimpleDom = str_get_html(mb_convert_encoding(Util :: sendHttpRequest(self :: BASE_URL . '/bio/new_page_1655.htm'), 'UTF-8', 'big5'));
			$objXmlChannel -> addChild('title', '生物教學影片');
			$objXmlChannel -> addChild('link', self :: BASE_URL . '/bio/new_page_1655.htm');
